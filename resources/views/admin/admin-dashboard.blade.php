                ...
                <div class="row g-3">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <ul class="breadcrumb mb-0">
                            <li class=""><a href="admin-dashboard">Street Stuff</a></li>&nbsp; /&nbsp; <li
                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            ...
                            <ul class="header-dropdown list-unstyled">
                                <li><a class="tab_btn" href="javascript:void(0);" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Weekly">W</a></li>
                                <li><a class="tab_btn" href="javascript:void(0);" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Monthly">M</a></li>
                                <li><a class="tab_btn active" href="javascript:void(0);" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Yearly">Y</a>
                                </li>
                                <li class="dropdown">
                        ...
                        <div class="card-body todo_list">
                            <div class="d-flex justify-content-between mb-3">
                                <div class="form-check">
                                    ...
                                    <span class="text-muted d-flex small">SCHEDULED FOR 3:00 P.M. ON JUN
                                        2021</span>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between mb-3">
                                <div class="form-check">
                                    ...
                                    <span class="text-muted d-flex small">SCHEDULED FOR 4:30 P.M. ON JUN
                                        2021</span>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between mb-3">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover align-middle">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img src="{{ asset('admin-asset/images/xs/avatar1.jpg') }}"
                                                    class="avatar rounded-circle" alt=""></td>
                                        ...
                                        <tr>
                                            <td><img src="{{ asset('admin-asset/images/xs/avatar2.jpg') }}"
                                                    class="avatar rounded-circle" alt=""></td>
                                            <td>Susie Willis</td>
                                        ...
                                        <tr>
                                            <td><img src="{{ asset('admin-asset/images/xs/avatar3.jpg') }}"
                                                    class="avatar rounded-circle" alt=""></td>
                                        ...
                                        <tr>
                                            <td><img src="{{ asset('admin-asset/images/xs/avatar4.jpg') }}"
                                                    class="avatar rounded-circle" alt=""></td>
                                            <td>Erin Gonzales</td>
                                        ...
                                        <tr>
                                            <td><img src="{{ asset('admin-asset/images/xs/avatar5.jpg') }}"
                                                    class="avatar rounded-circle" alt=""></td>
                                            <td>Ava Alexander</td>
                                            <td><span>UI UX Designer</span></td>
                                            <td><span class="badge bg-success">Good</span></td>
